...
if(cnz1[1,1]==true&&cnz1[0,1]==true&&cnz1[1,0]==true&&cnz1[0,0]==false&&cnz2[1,1]==false&&cnz2[0,1]==false&&cnz2[1,0]==false)
{
    ...
    d3d_model_vertex_normal_texture_color(mod_chunk,x2,y1,zm,lx,ly,lz,txl,tym,16777215,1);
    lx=-1;ly=-1;lz=1;
    d3d_model_vertex_normal_texture_color(mod_chunk,x1,y2,zm,lx,ly,lz,txm,tym,16777215,1);
    d3d_model_vertex_normal_texture_color(mod_chunk,x1,ym,z1,lx,ly,lz,txl,tyl,16777215,1);
    d3d_model_vertex_normal_texture_color(mod_chunk,x2,y1,zm,lx,ly,lz,txl,tym,16777215,1);
    
    d3d_model_vertex_normal_texture_color(mod_chunk,x1,ym,z1,lx,ly,lz,txm,tym,16777215,1);
    d3d_model_vertex_normal_texture_color(mod_chunk,xm,y1,z1,lx,ly,lz,txl,tyl,16777215,1);
    d3d_model_vertex_normal_texture_color(mod_chunk,x2,y1,zm,lx,ly,lz,txl,tym,16777215,1);
    return(true);
}
//z- x- y+
if(cnz1[0,1]==true&&cnz1[1,1]==true&&cnz1[0,0]==true&&cnz1[1,0]==false&&cnz2[0,1]==false&&cnz2[1,1]==false&&cnz2[0,0]==false)
{
    ...
    d3d_model_vertex_normal_texture_color(mod_chunk,x2,y2,zm,lx,ly,lz,txl,tyl,16777215,1);
    d3d_model_vertex_normal_texture_color(mod_chunk,x1,y2,zm,lx,ly,lz,txm,tym,16777215,1);
    d3d_model_vertex_normal_texture_color(mod_chunk,x1,y1,zm,lx,ly,lz,txl,tym,16777215,1);
    lx=1;ly=-1;lz=1;
    ...
    d3d_model_vertex_normal_texture_color(mod_chunk,x2,y2,zm,lx,ly,lz,txl,tym,16777215,1);
    
    d3d_model_vertex_normal_texture_color(mod_chunk,x2,ym,z1,lx,ly,lz,txm,tym,16777215,1);
    d3d_model_vertex_normal_texture_color(mod_chunk,x1,y1,zm,lx,ly,lz,txl,tym,16777215,1);
    d3d_model_vertex_normal_texture_color(mod_chunk,xm,y1,z1,lx,ly,lz,txl,tyl,16777215,1);
    return(true);
}
...
if(cnz1[0,0]==true&&cnz1[1,0]==true&&cnz1[0,1]==true&&cnz1[1,1]==false&&cnz2[0,0]==false&&cnz2[0,1]==false&&cnz2[1,0]==false)
{
    ...
    d3d_model_vertex_normal_texture_color(mod_chunk,x1,y2,zm,lx,ly,lz,txm,tym,16777215,1);
    d3d_model_vertex_normal_texture_color(mod_chunk,x2,y1,zm,lx,ly,lz,txl,tym,16777215,1);
    d3d_model_vertex_normal_texture_color(mod_chunk,xm,y2,z1,lx,ly,lz,txl,tyl,16777215,1);
...
if(cnz2[1,1]==true&&cnz2[0,1]==true&&cnz2[1,0]==true&&cnz2[0,0]==false&&cnz1[1,1]==false&&cnz1[0,1]==false&&cnz1[1,0]==false)
{
    ...
    d3d_model_vertex_normal_texture_color(mod_chunk,x1,ym,z2,lx,ly,lz,txm,tym,16777215,1);
    d3d_model_vertex_normal_texture_color(mod_chunk,x2,y1,zm,lx,ly,lz,txl,tym,16777215,1);
    d3d_model_vertex_normal_texture_color(mod_chunk,xm,y1,z2,lx,ly,lz,txl,tyl,16777215,1);
    return(true);
}
//z+ x- y+
if(cnz2[0,1]==true&&cnz2[1,1]==true&&cnz2[0,0]==true&&cnz2[1,0]==false&&cnz1[0,1]==false&&cnz1[1,1]==false&&cnz1[0,0]==false)
{
    ...
    d3d_model_vertex_normal_texture_color(mod_chunk,x2,ym,z2,lx,ly,lz,txm,tym,16777215,1);
    d3d_model_vertex_normal_texture_color(mod_chunk,xm,y1,z2,lx,ly,lz,txl,tyl,16777215,1);
    d3d_model_vertex_normal_texture_color(mod_chunk,x1,y1,zm,lx,ly,lz,txl,tym,16777215,1);
    return(true);
}
...
if(cnz2[0,0]==true&&cnz2[1,0]==true&&cnz2[0,1]==true&&cnz2[1,1]==false&&cnz1[0,0]==false&&cnz1[0,1]==false&&cnz1[1,0]==false)
{
    ...
    lx=1;ly=1;lz=-1;
    d3d_model_vertex_normal_texture_color(mod_chunk,x1,y2,zm,lx,ly,lz,txm,tym,16777215,1);
    d3d_model_vertex_normal_texture_color(mod_chunk,xm,y2,z2,lx,ly,lz,txl,tyl,16777215,1);
    d3d_model_vertex_normal_texture_color(mod_chunk,x2,y1,zm,lx,ly,lz,txl,tym,16777215,1);
