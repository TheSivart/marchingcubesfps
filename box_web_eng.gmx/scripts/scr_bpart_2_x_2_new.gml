...
{
    d3d_model_vertex_normal_texture_color(mod_chunk,xm,y2,z1,1,1,0,txm,ty2,16777215,1);
    d3d_model_vertex_normal_texture_color(mod_chunk,x2,ym,z2,1,1,0,tx2,tym,16777215,1);
    d3d_model_vertex_normal_texture_color(mod_chunk,x2,ym,z1,1,1,0,tx2,tym,16777215,1);
...
{
    d3d_model_vertex_normal_texture_color(mod_chunk,xm,y2,z1,-1,1,0,txm,ty2,16777215,1);
    d3d_model_vertex_normal_texture_color(mod_chunk,x1,ym,z1,-1,1,0,tx1,tym,16777215,1);
    d3d_model_vertex_normal_texture_color(mod_chunk,x1,ym,z2,-1,1,0,tx1,tym,16777215,1);
...
if(cnz1[1,0]==false&&cnz2[1,0]==false&&cnz1[1,1]==true&&cnz2[1,1]==true&&cnz1[0,0]==true&&cnz2[0,0]==true)
{
    ...
    d3d_model_vertex_normal_texture_color(mod_chunk,xm,y1,z2,1,-1,0,txm,ty1,16777215,1);
    d3d_model_vertex_normal_texture_color(mod_chunk,xm,y1,z1,1,-1,0,txm,ty1,16777215,1);
    d3d_model_vertex_normal_texture_color(mod_chunk,x2,ym,z2,1,-1,0,tx2,tym,16777215,1);
    return(true);
}
