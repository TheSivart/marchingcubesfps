...
//z1 x2 y2
if(cnz1[0,0]==true&&cnz1[1,0]==true&&cnz2[1,0]==true&&cnz2[0,0]==false&&
   cnz1[0,1]==false&&cnz1[1,1]==false&&cnz2[1,1]==true&&cnz2[0,1]==false)
{
    lx=0;ly=1;lz=1;
...
/*
tx1=0;txm=0.25;tx2=0.5;ty1=0;tym=0.25;ty2=0.5;

//z1 x2 y2
if(cnz1[0,0]==true&&cnz1[1,0]==true&&cnz2[1,0]==false&&cnz2[0,0]==true&&
   cnz1[0,1]==false&&cnz1[1,1]==true&&cnz2[1,1]==false&&cnz2[0,1]==false)
{
    lx=0;ly=1;lz=1;
    d3d_model_vertex_normal_texture_color(mod_chunk,x1,ym,z1,lx,ly,lz,tx1,ty1,16777215,1);
    d3d_model_vertex_normal_texture_color(mod_chunk,x1,y1,zm,lx,ly,lz,txm,ty1,16777215,1);
