...
if(cnz1[1,0]==true&&cnz1[0,1]==false&&cnz1[1,1]==false&&cnz2[1,0]==false)
{
...
if(cnz2[1,0]==true&&cnz1[1,0]==false&&cnz2[0,1]==false&&cnz2[1,1]==false)
{
...
//x-
if(cnz1[0,1]==true&&cnz1[1,1]==false&&cnz1[1,0]==false&&cnz2[0,1]==false)
{
    d3d_model_vertex_normal_texture_color(mod_chunk,xm,y2,z1,1,-1,1,txl,tyl,16777215,1);
...
if(cnz2[0,1]==true&&cnz2[1,1]==false&&cnz2[1,0]==false&&cnz1[0,1]==false)
{
    d3d_model_vertex_normal_texture_color(mod_chunk,xm,y2,z2,1,-1,-1,txl,tyl,16777215,1);
